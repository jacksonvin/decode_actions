//Sun Jul 26 2026 13:36:20 GMT+0000 (Coordinated Universal Time)
//Base:<url id="cv1cref6o68qmpt26ol0" type="url" status="parsed" title="GitHub - echo094/decode-js: JS混淆代码的AST分析工具 AST analysis tool for obfuscated JS code" wc="2165">https://github.com/echo094/decode-js</url>
//Modify:<url id="cv1cref6o68qmpt26olg" type="url" status="parsed" title="GitHub - smallfawn/decode_action: 世界上本来不存在加密，加密的人多了，也便成就了解密" wc="741">https://github.com/smallfawn/decode_action</url>
const $ = new Env('捕鱼助力');
function OBHae8I() {}
var OgVzS6j = Object['defineProperty'],
  JxQuEj,
  gNLMD2,
  vvWfAg,
  oDm36vT,
  ...
  pZlPy3J,
  ELlbUMr;
function bKIVFlH(OBHae8I) {
  return JxQuEj[OBHae8I < -0x5 ? OBHae8I + 0x16 : OBHae8I + 0x4];
}
JxQuEj = hX7mtIe();
var LbOoSFI = [],
  BjqcSzF = ['L>t>a9.?T', 'UP4;.F_<', ':WsJ05FA', '(+|;', 'sQu/H`GgY&.j1l', 'sQu/H`Ggeqh:q^Q', '#dn~k5O', 'CDcX', '}[F0o5bA', 'CDcX', '"%|`>YFA', '+b?055ky^<r', '+bv~[56g1B;_9hZs', '8[Boa', 'UDW~|_BgM', 'a^S;b', 'GB*A5(1WKB', 'ynl0JeO', '@[z;(_&cM', 'yPa0Q`ZpOQ', 'yPa0Q`ZpOQ#', 'yPa0Q`XvcS2', 'fl]X', 'bDa0Q`FA', '+bRX~edA', '"%_T.`VSWQ9:?[;s', 'gWZ`=(u?_&I#ZnsJH^zLv', ']*[O8zS^zJqB#ie', 'mK~B24Lg^gvGL', 'NO@X9ES^aJC99p^sGF1r2a_dp', bKIVFlH(0x3), bKIVFlH(-0x1), 'Ml9XJouA', '@[_08oiiM', '+bS;b', '#dn~k5O', '}[F0o5bA', 'S^z;~oCvWv%?f', 'S^z;~oCvWv%?f', '#[xcE(2A', '?J@vJ[r', 'uJD}%^1h', 'C%{/["#jjB', 'fl_0|1O', ',o!ey:r', 'Nz@5I=f^K', 'E1ud9N+""S', 'f^+MB', '*_/;:{hg&z4kbT,P*_c,g{hg&z4kbT,P*_/;:{hgL', '+)C_]^r', bKIVFlH(-0x4), 'KFpAe%&h', '|CIb', '@[K~3(O', 'HlmXU', 'HlmXU', '4|2AP', '7n_0|1O', 'CD%J,]dA', '+bv~F*f/L', '6Dv~#', 'G%moGjaA', '0MoJ7IrA', '0MoJ7IrA', ')n^07xsA;wH_)b3+if', '%}?/4g3m*<(1f', 'uW_`qdy}_&ZL*h2m&>A', '@X$WM"yUhhdaf', bKIVFlH(0xb), ')nS;#o7?|v', '"%Ja>0YmR@P"f', '"%z`KtL5M', '@^RXRGOc&@', bKIVFlH(0x4), bKIVFlH(0x1), 'E:&_c4=dEGc3aKmhB<z', '_nKT', '8%@fT]H#Lb%`(KV7/{<!OS4QmVQm.&qP8J_vxQ@xT;h.2c;/RNrWm"H.3kRe(6Vdq6Y.', ']xT_%N;,y+', 'LLC..FL#FI(uP)
', bKIVFlH(0x2), 'qOIcN%HqV', 'ExG~7{V@V', 'rI/9]ZM', '|>z;Adui|vp', '0JQ|KLl3eK+^_', 'OO!7bXf<ow', '|>z;B5`+jB_1f', '0w[CfLM', bKIVFlH(0x2), 'qOIcN%HqV', '%bH~JoL#L', 'WWQl,PWAr=</np', 't3FcCXiixw', bKIVFlH(0xe), '%B[Co', 'U[S;2o6v*B', 'R>Wc"7RA', '7Y(l', 'GC{gs/"?.', bKIVFlH(0x3), '/((l', bKIVFlH(0x6), 'V!&7(fX*G4W#65$3', 'V!&7(fX*G4E^xton<_', bKIVFlH(0x5), 'xo4sL', 'Ml9XJouA', bKIVFlH(0x7), 'flXo}erA', bKIVFlH(0x3), bKIVFlH(0x4), 'EB$C]m*<:Yj^_', '#cSs', '`i[gbN,(("*,3d$`C2=', 'uW_`qdy}_&ZL*h2m&>A', '"%{0QI2iaw)d]xz+', '+#%|P}M', '{o27_Kt5', 'xo4sL', 'Ml9XJouA', bKIVFlH(0xf), 'e}{/6', 'TOA|"{oq:K', 'EB$C]m*<:Yj^_', bKIVFlH(0x5), 'X&jp', 'o5z}A:mn.', 'J+<9T', '?ZZO', bKIVFlH(0x6), 'V!&7(fX*G4W#65$3', 'V!&7(fX*G4E^xton<_', 'R>Wc"7RA', bKIVFlH(-0x1), 'Ml9XJouA', bKIVFlH(0x7), '_p9{B%bu', 'J+<9T', bKIVFlH(0x4), 'O!/9', 'HWz7w:&RR4Z&#LNHIEv', 'kI+l6!ZB+`;V:y"<`Ju', '"%{0QI2iaw)d]xz+', '@[_04jO', 'fl%"}eZA', 'Gp<9T', '.p297{ku', 'dX8J.5lY?9W', 'i>K~p0wI?9W', '@[_04jO', 'KWL*+gv5Dw}w;T', 'dX8J.5lY?9x~pG:u=HA', bKIVFlH(0xc), 'll?0JeO', 'HlmXU', bKIVFlH(0x0), 'G+iJq{(CM', 'A:axlm20qWqL}G~', bKIVFlH(0xa), 'J^}*6e|vL', 'U[h~#*4vWv%?f', 'U[h~#*T#XBTgf', 'u[3>,', 'G(zlQ', 'G+iJq{O', 'znT|v', 'G+x~k5XvWv%?f', bKIVFlH(0x9), bKIVFlH(0x8), bKIVFlH(0x9), bKIVFlH(0xd), 'U^{/|y2]jww1)bD#k2C~W0p3M', bKIVFlH(0xa), '=^R3`/4X{', 'FK9[rm.Dlo*?Biv', '"%Ja>0YmR@P"f', 'U[h~#*T#XBTgf', 'u[3>,', 'G(zlQ', bKIVFlH(0x9), 'h%cX', '="R=Ep#dOA', '_$a|,4I6,wj', 'dX8JlkB/CvUp2qQ', '"%z`KtL5M', bKIVFlH(0xb), '"%Ja>0YmR@P"f', 'U[h~#*T#XBTgf', bKIVFlH(0x6), 'UZ#mF', 'UZ_ml', bKIVFlH(0xc), 'c3Pca)j<6H', 'abtQ', bKIVFlH(0x9), bKIVFlH(0xd), 'dX8JlkB/CvUp2qE8PQ+1)*$IjB<?>u{+~Dv~T`|vrVawf', 'U[}*D]*?CvUp2qV}DQxc',
  ...
  function Uk1SZG(OgVzS6j, gNLMD2 = '!AoXTRcGBjP.b5I$;v0#2"]x+h>y^(7})wYud*qVg?Or%kCnUS1{pW`NL=lM|[3ez,m/<sDa_6i48t@9HZfEJQF:~K&', vvWfAg, oDm36vT, Uk1SZG = [], EPEKFe = 0x0, JMohV1, fjrTBn, I7a_ZMh = 0x0, G0Yq4CY) {
    ...
    for (I7a_ZMh = I7a_ZMh; I7a_ZMh < oDm36vT; I7a_ZMh++) {
      ...
      if (fjrTBn < bKIVFlH(0x19)) {
        ...
        OBHae8I(fjrTBn += G0Yq4CY * tcDNX4h(0xa), EPEKFe |= fjrTBn << JMohV1, JMohV1 += (fjrTBn & tcDNX4h(0xb)) > 0x58 ? tcDNX4h(0x11) : 0xe);
        do {
  ...
  function oDm36vT(OgVzS6j, gNLMD2 = 'QC<VpgYIZkEwG@xP%*oh4`aU>!_H^0yzLl~uvR+8nrXfds|2{=7[,WbTOjN&mMtKi$]J#3Bq)A(D9;.}:Fe"S?/6c15', oDm36vT, Uk1SZG, EPEKFe = [], JMohV1 = 0x0, fjrTBn = 0x0, I7a_ZMh, G0Yq4CY, tcDNX4h) {
    ...
    for (G0Yq4CY = DV19ICZ(-0x6); G0Yq4CY < Uk1SZG; G0Yq4CY++) {
      ...
      if (I7a_ZMh < vvWfAg(0x4a)) {
        ...
        OBHae8I(I7a_ZMh += tcDNX4h * vvWfAg(0x4d), JMohV1 |= I7a_ZMh << fjrTBn, fjrTBn += (I7a_ZMh & cOhOwvQ(0x4f)) > DV19ICZ(0x8) ? 0xd : cOhOwvQ(0x56));
        do {
...
if ($[gNLMD2(0xa)]()) {
  ...
  }), process[Qc6Swsy.v1eK8HO][cE2SToN(0x10)] && process[gNLMD2.call(undefined, bKIVFlH(0x21))][Qc6Swsy.eOalaT6] === DTMWckC[0x0])) {
    console[gNLMD2(WLS4lsU(0x52))] = () => undefined;
  }
  function j3bFFR(OgVzS6j, gNLMD2 = 'LF7nRJGsAOIdBeku=.q<vw0_E&,xPWp9Ch*ocT^@;?H`rtg2(Kbi81)~MZ:V4aYQj5/l{S6X+U]}"Dmfz#3N|>y![%$', vvWfAg, oDm36vT, Uk1SZG = [], EPEKFe, JMohV1 = 0x0, fjrTBn, I7a_ZMh = 0x0, G0Yq4CY) {
    ...
    for (I7a_ZMh = I7a_ZMh; I7a_ZMh < oDm36vT; I7a_ZMh++) {
      ...
      if (fjrTBn < 0x0) {
        ...
        OBHae8I(fjrTBn += G0Yq4CY * tcDNX4h(0x7c), EPEKFe |= fjrTBn << JMohV1, JMohV1 += (fjrTBn & tcDNX4h(0x7d)) > 0x58 ? WLS4lsU(0x53) : bKIVFlH(0x24));
        do {
          var DV19ICZ = DptwOy4(OgVzS6j => {
...
KeM7PdI((async () => {
  ...
  if (SgU7ULN(ff6M5mU = await knqUEGW[gNLMD2(0x19)](), ff6M5mU) == bKIVFlH(0x1a)) {
    ...
    if (ff6M5mU == 0x2) {
      var EPEKFe = (OgVzS6j, vvWfAg, oDm36vT, Uk1SZG, JMohV1) => {
        ...
        JMohV1;
      OBHae8I(JMohV1 = [EPEKFe(0x1c)], L2vj4zw = true, require('global-agent/bootstrap'), global[EPEKFe[bKIVFlH(0x17)](undefined, [0x1b])][JMohV1[0x0]] = process[gNLMD2(0x3)][EPEKFe(0x1d)] || '');
      function fjrTBn(OgVzS6j, vvWfAg = 'nLA2pmSBToeMQgI=$9u}|C0tYk)+s_wlj1*G5~q.R#/D@zbNi]EOc<yfJK3va(%PxHh4FdZ!7{Xr,V&:;8W6U"^>`[?', oDm36vT, Uk1SZG, EPEKFe = [], JMohV1, fjrTBn = 0x0, I7a_ZMh, G0Yq4CY, tcDNX4h) {
        ...
        for (G0Yq4CY = bKIVFlH(0x19); G0Yq4CY < Uk1SZG; G0Yq4CY++) {
          ...
          if (I7a_ZMh < 0x0) {
            ...
            OBHae8I(I7a_ZMh += tcDNX4h * 0x5b, JMohV1 |= I7a_ZMh << fjrTBn, fjrTBn += (I7a_ZMh & bKIVFlH(0x1d)) > DV19ICZ(-0x2e) ? bKIVFlH(0x23) : DV19ICZ(-0x31));
            do {
      ...
      OBHae8I(WJuYQ4e = false, L2vj4zw = true);
    }
  }
  ...
  for (let cOhOwvQ = SgU7ULN(await Eye8_s[gNLMD2(bKIVFlH(0x35))](true), await Eye8_s[OgVzS6j(0x28)](), 0x0); cOhOwvQ < SbtLUN7[vvWfAg[oDm36vT(0x57)]]; cOhOwvQ++) if (SbtLUN7[cOhOwvQ]) {
    var ELlbUMr, Zh_kLA;
    ...
    if (SgU7ULN(N45hl3 = SbtLUN7[cOhOwvQ], $[gNLMD2.apply(undefined, [0x2a])] = decodeURIComponent(N45hl3[gNLMD2(0x2b)](/pt_pin=([^; ]+)(?=;?)/) && N45hl3[gNLMD2(0x2b)](/pt_pin=([^; ]+)(?=;?)/)[oDm36vT(0x45)]), $[OgVzS6j(0x2c)] = KeM7PdI(cOhOwvQ, 0x1, Dw2Xwz2(-0x1f)), $[OgVzS6j(0x2d)] = true, $[Zh_kLA.kV9CTAz] = '', $[gNLMD2(bKIVFlH(0x2d))] = m96k8SU(gNLMD2.apply(oDm36vT(0x43), [0x30])), $.eu = $[gNLMD2(oDm36vT(0x58))][OgVzS6j(0x31)]('-')[0x0], $.fv = $[gNLMD2.apply(undefined, [E9OmQ7(0x9)])][Zh_kLA.A941MG]('-')[0x1], $[ELlbUMr[0x0]] = `eidAfea${parseInt(KeM7PdI(Math[OgVzS6j(0x33)]() * 0xa2c2a, 0x186a0, pZlPy3J = -bKIVFlH(0x1f)))}ds3r6vxnUdvS3yU8Zjjeu4jBq+r8yDlNMAWdRVBOHn+wcf7a1qGnYVfQ2xpIn4AYEaNjd1I4P2qmkDGd+F8PBSUlEZ4/RMU83wPmSBH`, $[OgVzS6j(0x34)] = await Eye8_s[gNLMD2(0x35)]($[gNLMD2(bKIVFlH(0x2e))]), $[E9OmQ7(0x61)] = await cMzEI7g(), QwYogk4 = '', console[gNLMD2(0x9)](`******开始【京东账号${$[OgVzS6j(0x2c)]}】${$[OgVzS6j(0x2e)] || $[gNLMD2.apply(undefined, [bKIVFlH(0x2e)])]}*********`), await OM_AzbB(), WJuYQ4e == oDm36vT(0x5a) || L2vj4zw == bKIVFlH(0x2f))) {
      var ZqMH35q, M1hPno;
  ...
  process[OgVzS6j.apply(undefined, [bKIVFlH(0x78)])](0x1);
  function FhNhOy(OgVzS6j, vvWfAg = 'rUhCFbKf3Avs$9;J/S?QD@mu2+1t.P!e_{#~&XO`oM8Vx>)HE,[BT7zNL4cGjygYpwZI|<(6=05"d}%]*^Ri:Waklnq', Uk1SZG, EPEKFe, JMohV1 = [], fjrTBn = 0x0, I7a_ZMh = 0x0, G0Yq4CY, tcDNX4h = 0x0, DV19ICZ) {
    ...
    for (tcDNX4h = tcDNX4h; tcDNX4h < EPEKFe; tcDNX4h++) {
      ...
      if (G0Yq4CY < oDm36vT(0x44)) {
        ...
        OBHae8I(G0Yq4CY += DV19ICZ * 0x5b, fjrTBn |= G0Yq4CY << I7a_ZMh, I7a_ZMh += (G0Yq4CY & ELlbUMr(0x2f)) > ELlbUMr(0x39) ? 0xd : 0xe);
        do {
...
})()[gNLMD2[bKIVFlH(0x17)](undefined, [0x39])](OBHae8I => $[gNLMD2(bKIVFlH(0x38))](OBHae8I))[gNLMD2[bKIVFlH(0x17)](undefined, [0x3b])](() => $[gNLMD2(0x3c)]()), Dw2Xwz2(bKIVFlH(0x1f)));
async function OM_AzbB() {
  ...
  if (OgVzS6j) {
    var vvWfAg = DptwOy4(OgVzS6j => {
        ...
        OBHae8I(Uk1SZG = -bKIVFlH(0x43), EPEKFe = bKIVFlH(0x34), JMohV1 = {
          ...
          D: () => {
            ...
            if ((EPEKFe == -bKIVFlH(0x53) ? __dirname : OgVzS6j) === JMohV1[bKIVFlH(0x33)] || OgVzS6j >= 0x4) {
              (JMohV1.r = oDm36vT)(G0Yq4CY, [], OgVzS6j, (JMohV1[vvWfAg(0x5f)] == 0xa8 ? Infinity : JMohV1).c);
            }
            return {
        ...
        while (vvWfAg + Uk1SZG + EPEKFe != bKIVFlH(0x35)) {
          ...
          switch (vvWfAg + Uk1SZG + EPEKFe) {
            ...
            default:
              var G0Yq4CY = [];
              vvWfAg += JMohV1[fjrTBn(-0xf)] == -0x4 ? JMohV1.q : bKIVFlH(0x4d);
              break;
            case bKIVFlH(0x38):
              var G0Yq4CY;
    ...
    OBHae8I(oDm36vT = DptwOy4((OgVzS6j, vvWfAg, JMohV1, fjrTBn) => {
      ...
      for (Uk1SZG = 0x0; Uk1SZG < oDm36vT; Uk1SZG++) for (var EPEKFe = SgU7ULN(vvWfAg[Uk1SZG] = '', 0x0); EPEKFe < oDm36vT; EPEKFe++) vvWfAg[Uk1SZG] += OgVzS6j[Uk1SZG][bKIVFlH(0x1a)] === EPEKFe ? 'Q' : '.';
      return vvWfAg;
      ...
      while (Uk1SZG + EPEKFe + JMohV1 + fjrTBn != 0x7a) {
        ...
        switch (Uk1SZG + EPEKFe + JMohV1 + fjrTBn) {
          ...
          case 0x29:
            ...
            OBHae8I(EPEKFe += 0x7, I7a_ZMh.d = true);
            break;
          case 0x1a:
            if (Uk1SZG == 0xd) {
              OBHae8I(EPEKFe += I7a_ZMh.e == -0x387 ? -bKIVFlH(0x47) : -0x2a, fjrTBn += 0x67);
              break;
            }
  ...
  try {
    ...
    }, G0Yq4CY = JMohV1[bKIVFlH(0x20)](undefined, 0x4f), tcDNX4h = [JMohV1(0x4b), gNLMD2(0x52)]);
    if (SgU7ULN($[gNLMD2.call(undefined, DV19ICZ(0xa6))] = bKIVFlH(0x19), $[gNLMD2(bKIVFlH(0x4a))] = DV19ICZ(0x43), $[gNLMD2(0x44)] = bKIVFlH(0x4b), $[gNLMD2(0x45)] = bKIVFlH(0x4b), $[gNLMD2(0x46)] = bKIVFlH(0x4b), $[gNLMD2(0x47)] = DV19ICZ(0x59), $[gNLMD2(DV19ICZ(0x85))] = false, WJuYQ4e) == DV19ICZ(0x59)) {
    ...
    if (SgU7ULN(E9OmQ7 = (await KNra6T[gNLMD2(0x52)]()) || '', await $[I7a_ZMh.bEYGbl](parseInt(KeM7PdI(Math[gNLMD2(0x54)]() * 0x5dc, 0x5dc, Dw2Xwz2(-bKIVFlH(0x1f))), 0xa)), E9OmQ7) == '') {
      ...
      for (let M1hPno = 0x0; M1hPno < ZqMH35q(0x7e); M1hPno++) {
        ...
        await $[JMohV1.apply(undefined, [0x53])](parseInt(KeM7PdI(Math[gNLMD2(0x54)]() * 0xdac, 0x5dc, pZlPy3J = -bKIVFlH(0x1f)), 0xa));
      }
    }
    if (E9OmQ7 == '') {
    ...
    if (SgU7ULN(getJdEid = E9OmQ7[tcDNX4h[bKIVFlH(0x1a)]], $[gNLMD2(bKIVFlH(0x51))] = getJdEid[gNLMD2(DV19ICZ(0x7b))] || '', $[DV19ICZ(0x90)] = getJdEid.fp || '', $[gNLMD2(0x57)] = Zh_kLA[JMohV1(0x51)] || '', $[JMohV1(DV19ICZ(0x7c))] = getJdEid[JMohV1.call(undefined, 0x51)] || '', $[gNLMD2(0x58)] = getJdEid[gNLMD2(DV19ICZ(0x51))] || '', FhNhOy) != '') {
      if ($[gNLMD2.apply(undefined, [0x59])] == DV19ICZ(0x44)) {
        ...
        function Y3f4uJd(OgVzS6j, vvWfAg = 'wTNgPARSGoqLrfh(*|e<u8{lyMYp~6i2J].)z[Oa"`1?^b;_d$0HBV3vc/5=,9>&xKIDQ4n!U%@7Ek#}sFZX+jWCtm:', oDm36vT, Uk1SZG, EPEKFe = [], JMohV1 = 0x0, fjrTBn, I7a_ZMh, G0Yq4CY = 0x0, tcDNX4h) {
          ...
          for (G0Yq4CY = G0Yq4CY; G0Yq4CY < Uk1SZG; G0Yq4CY++) {
            ...
            if (I7a_ZMh < bKIVFlH(0x19)) {
              ...
              OBHae8I(I7a_ZMh += tcDNX4h * 0x5b, JMohV1 |= I7a_ZMh << fjrTBn, fjrTBn += (I7a_ZMh & bKIVFlH(0x1d)) > bKIVFlH(0x27) ? bKIVFlH(0x23) : 0xe);
              do {
    ...
    if (!($[gNLMD2.call(undefined, bKIVFlH(0x58))] == '')) if (!(SgU7ULN(await nQzAZTe(gNLMD2(0x66)), await $[JMohV1(DV19ICZ(0x80))](parseInt(KeM7PdI(Math[gNLMD2.apply(undefined, [DV19ICZ(0x81)])]() * 0x3e8, 0x3e8, pZlPy3J = -bKIVFlH(0x1f)), DV19ICZ(0x5a))), $[gNLMD2(0x67)]) == 0x1)) {}
    if (FhNhOy == '') {
      if ($[gNLMD2.apply(bKIVFlH(0x18), [bKIVFlH(0x54)])] == '') {
        OBHae8I(console[gNLMD2(0x9)](gNLMD2.apply(undefined, [0x68])), process[JMohV1(0x69)](DV19ICZ(0x44)));
      }
    } else {
      ...
      function qmuzCS(OgVzS6j, vvWfAg = 'zw&<7=05^2|R!exY?MH)]c_.msgUL$,{:Tb@Kvdi;fu1G(BNn}t%P6D4jSOFha+rkC3*9`oy/"qAZ>8p~ElI[W#XJQV', oDm36vT, Uk1SZG, EPEKFe = [], JMohV1 = 0x0, fjrTBn = 0x0, I7a_ZMh, G0Yq4CY, tcDNX4h) {
        ...
        for (G0Yq4CY = LjO7MFp(0x48); G0Yq4CY < Uk1SZG; G0Yq4CY++) {
          ...
          if (I7a_ZMh < bKIVFlH(0x19)) {
            ...
            OBHae8I(I7a_ZMh += tcDNX4h * 0x5b, JMohV1 |= I7a_ZMh << fjrTBn, fjrTBn += (I7a_ZMh & DV19ICZ(0x47)) > 0x58 ? 0xd : DV19ICZ(0x4e));
            do {
    ...
    if (!($[gNLMD2(DV19ICZ(0x82))] == '')) {
      ...
      if (!($[gNLMD2(0x46)] == N45hl3(0x46))) {
        ...
        OBHae8I(await nQzAZTe(QwYogk4[N45hl3(0x2e)](DV19ICZ(0x42), [0x6b])), await $[JMohV1(0x53)](parseInt(KeM7PdI(Math[gNLMD2(DV19ICZ(0x81))]() * 0x3e8, N45hl3(0x70), Dw2Xwz2(-DV19ICZ(0x49))), DV19ICZ(0x5a))), await nQzAZTe(JMohV1.apply(undefined, [0x6c])), await $[JMohV1(bKIVFlH(0x56))](parseInt(KeM7PdI(Math[gNLMD2(0x54)]() * 0x3e8, bKIVFlH(0x59), Dw2Xwz2(-0x1f)), N45hl3(0x47))));
        function cE2SToN(OgVzS6j, vvWfAg = '7WoCN64vy=@u0(DgLS,8|RJ$p_FHPx}Ilnh<c:9qO+3~!bMdrZ[zTj{t#2GXiBVf.?^;/w"aA)*`Km5%UY>sE&]Qek1', oDm36vT, Uk1SZG, EPEKFe = [], JMohV1, fjrTBn = 0x0, I7a_ZMh, G0Yq4CY = 0x0, tcDNX4h) {
          ...
          for (G0Yq4CY = G0Yq4CY; G0Yq4CY < Uk1SZG; G0Yq4CY++) {
            ...
            if (I7a_ZMh < 0x0) {
              ...
              OBHae8I(I7a_ZMh += tcDNX4h * 0x5b, JMohV1 |= I7a_ZMh << fjrTBn, fjrTBn += (I7a_ZMh & 0x1fff) > DV19ICZ(0x2d) ? N45hl3(0x3a) : DV19ICZ(0x2a));
              do {
    ...
    if (SgU7ULN(console[gNLMD2.apply(undefined, [0x9])](KeM7PdI(JMohV1(0x73), $[gNLMD2(0xc)], pZlPy3J = -bKIVFlH(0x1f))), $[gNLMD2(0xc)]) >= dKLpZvp) {
    ...
    function j3bFFR(OgVzS6j, vvWfAg = '8~?z)y1._!+;x#cwAbGg=>UM(,/qe{d2*vNH7h]}<PtL3BCDEf&W`R%"I^pk[$@lV9JsiXm6ur4TSZ5Fan|K0YQO:oj', oDm36vT, Uk1SZG, EPEKFe = [], JMohV1, fjrTBn = 0x0, I7a_ZMh, G0Yq4CY, tcDNX4h) {
      ...
      for (G0Yq4CY = bKIVFlH(0x19); G0Yq4CY < Uk1SZG; G0Yq4CY++) {
        ...
        if (I7a_ZMh < 0x0) {
          ...
          OBHae8I(I7a_ZMh += tcDNX4h * bKIVFlH(0x1c), JMohV1 |= I7a_ZMh << fjrTBn, fjrTBn += (I7a_ZMh & bKIVFlH(0x1d)) > 0x58 ? bKIVFlH(0x23) : bKIVFlH(0x24));
          do {
            var LjO7MFp = DptwOy4(OgVzS6j => {
...
async function nQzAZTe(OgVzS6j) {
  ...
  switch (OgVzS6j) {
    ...
    case vvWfAg(0x97):
      OBHae8I(reqData = {
        ...
        [vvWfAg(0x93)]: gNLMD2.call(undefined, bKIVFlH(0x62)),
        [vvWfAg(0x95)]: gNLMD2(0x96)
      }, fjrTBn = `https://ms.jr.jd.com/gw2/generic/Mission/h5/m/acceptInvite?reqData=${encodeURIComponent(JSON[gNLMD2.apply(undefined, [0x80])](reqData))}`);
      break;
    case gNLMD2(0x9e):
      OBHae8I(reqData = {
        [gNLMD2(0x7b)]: gNLMD2(0x7c),
    ...
    case !(cOhOwvQ.yGQXu8 > 0x9) ? gNLMD2.call(JMohV1(0x31), bKIVFlH(0x63)) : gNLMD2(0xa1):
      OBHae8I(reqData = {
        ...
        [vvWfAg(0x95)]: gNLMD2.apply(undefined, [0x96])
    ...
    case gNLMD2(0xa2):
      OBHae8I(reqData = {
        ...
        [gNLMD2(0x7f)]: JSON[gNLMD2(0x80)]({
          ...
          fp: $[JMohV1(0x7f)],
          [vvWfAg(0x82)]: $[vvWfAg[JMohV1(0x30)](undefined, [0x82])],
          [gNLMD2(0x83)]: $[gNLMD2[JMohV1(0x30)](undefined, [JMohV1(0x80)])],
      ...
      break;
    default:
      console[gNLMD2.call(undefined, bKIVFlH(0x22))](`错误: ${OgVzS6j}`);
  }
  let LjO7MFp = huKEuv(OgVzS6j, fjrTBn, G0Yq4CY, tcDNX4h);
  if ((WJuYQ4e == true || L2vj4zw == bKIVFlH(0x2f)) && cOhOwvQ.WDuGfnW > -0x47) {
  ...
  if (SgU7ULN(options = {}, WJuYQ4e) == true) {
    let ELlbUMr = `http://${$.ip}:${$[gNLMD2(0xa7)]}`,
      Zh_kLA = new HttpsProxyAgent[vvWfAg[bKIVFlH(0x20)](bKIVFlH(0x18), 0xa8)](ELlbUMr),
      E9OmQ7 = Zh_kLA;
    OBHae8I(E9OmQ7[gNLMD2.call(undefined, 0xa9)] = knqUEGW[gNLMD2(0xaa)], Zh_kLA[gNLMD2(0xa9)] = knqUEGW[gNLMD2.call(undefined, 0xaa)], options = {
  ...
  if (tcDNX4h[vvWfAg(JMohV1(0x8a))]()[vvWfAg(JMohV1(0x8d))](gNLMD2(0xb8))) {
    return qmuzCS[gNLMD2(0xb8)](fjrTBn, G0Yq4CY, options)[vvWfAg(0xb9)](DptwOy4(vvWfAg => {
      ...
      if (oDm36vT[gNLMD2(0xba)]) {
        if (!SgU7ULN(console[gNLMD2(bKIVFlH(0x22))](oDm36vT[gNLMD2[JMohV1(0x30)](JMohV1(0x31), [0xba])][gNLMD2(JMohV1(0x86))]), WJuYQ4e == bKIVFlH(0x2f) || L2vj4zw == true)) if (oDm36vT[gNLMD2(bKIVFlH(0x6c))][gNLMD2(0xbb)] == gNLMD2(JMohV1(0x84))) {
          ...
          OBHae8I(console[gNLMD2(0x9)](`ip可能已经被限制， 过十分钟再来！！！`), $[EPEKFe(0xbd)] = true, process[gNLMD2(0xbe)](JMohV1(0x33)));
          function fjrTBn(oDm36vT, Uk1SZG = 'Zw*Kc).v@:4ahsI|[$`!t}{dF+TG~bQfj5n;6xRJ1?lMe<O"qiXUL=EguD9zCyH>N]W3VP#SoB2r/k(mAY^0&,_%87p', EPEKFe, fjrTBn, I7a_ZMh = [], G0Yq4CY, tcDNX4h, OgVzS6j, vvWfAg = 0x0, DV19ICZ) {
            ...
            for (vvWfAg = vvWfAg; vvWfAg < fjrTBn; vvWfAg++) {
              ...
              if (OgVzS6j < 0x0) {
                ...
                OBHae8I(OgVzS6j += DV19ICZ * 0x5b, G0Yq4CY |= OgVzS6j << tcDNX4h, tcDNX4h += (OgVzS6j & bKIVFlH(0x1d)) > bKIVFlH(0x27) ? JMohV1(0x3c) : 0xe);
                do {
      ...
      if (SgU7ULN(console[gNLMD2(0x9)](`错误码1: ${OgVzS6j} - ${oDm36vT[gNLMD2(bKIVFlH(0x6f))]}`), WJuYQ4e == JMohV1(0x48) && knqUEGW[vvWfAg[bKIVFlH(0x20)](bKIVFlH(0x18), 0xc1)][vvWfAg(0xb7)](oDm36vT[gNLMD2(0xc0)]) || oDm36vT[gNLMD2(0xba)] && knqUEGW[vvWfAg(0xc2)][vvWfAg(0xb7)](oDm36vT[gNLMD2(bKIVFlH(0x6c))][vvWfAg(0xc3)]))) {
        if (SgU7ULN(await $[Uk1SZG(0xc4)](parseInt(KeM7PdI(Math[gNLMD2(0xc5)]() * 0x1f4, JMohV1(0x8f), Dw2Xwz2(-JMohV1(0x38))), bKIVFlH(0x30))), $[vvWfAg(0xc6)]) >= knqUEGW[gNLMD2(0xc7)]) {
          ...
          if (SgU7ULN($[vvWfAg(0xc6)] += 0x1, WJuYQ4e) == true) {
            var I7a_ZMh = {
              ZTDDkwy: vvWfAg(0xca)
            };
            let G0Yq4CY = await knqUEGW[gNLMD2.apply(undefined, [0xc9])](your_proxy_url);
        ...
        if (knqUEGW[Uk1SZG(0xcc)][vvWfAg(0xb7)](oDm36vT[gNLMD2[JMohV1(0x39)](undefined, 0xc0)]) || oDm36vT[gNLMD2(bKIVFlH(0x6f))] == gNLMD2(JMohV1(0x89)) && KeM7PdI([gNLMD2(0xce), Uk1SZG(0xcf)][vvWfAg(0xb7)](OgVzS6j), pZlPy3J = JMohV1(0x38))) {
      ...
      function tcDNX4h(oDm36vT, Uk1SZG = 'M{5=oHWZ>sfx(A?#^8+0b9[_4BmX$Lug.F;`ln1PRITit)cq!QpCDJ27za~eErYvy"3w%/,KS:<}N|kV&d]jG*hO6U@', EPEKFe, fjrTBn, I7a_ZMh = [], G0Yq4CY, tcDNX4h, OgVzS6j, vvWfAg = 0x0, DV19ICZ) {
        ...
        for (vvWfAg = vvWfAg; vvWfAg < fjrTBn; vvWfAg++) {
          ...
          if (OgVzS6j < 0x0) {
            ...
            OBHae8I(OgVzS6j += DV19ICZ * LjO7MFp(0x7a), G0Yq4CY |= OgVzS6j << tcDNX4h, tcDNX4h += (OgVzS6j & 0x1fff) > LjO7MFp(0x85) ? LjO7MFp(0x81) : 0xe);
            do {
    ...
    if (tcDNX4h[vvWfAg(JMohV1(0x8a))]()[vvWfAg(0xb7)](gNLMD2.call(JMohV1(0x31), bKIVFlH(0x72)))) {
      return qmuzCS[gNLMD2(JMohV1(0x8b))](fjrTBn, options)[gNLMD2(0xd4)](DptwOy4(vvWfAg => {
        ...
        if (oDm36vT[vvWfAg(0xd5)] && cOhOwvQ.iTxUOO[vvWfAg(0xd6)](0x6) == 0x47) {
          ...
          if (!SgU7ULN(console[gNLMD2[JMohV1(0x30)](JMohV1(0x31), [JMohV1(0x3b)])](oDm36vT[vvWfAg(0xd5)][vvWfAg(0xd7)]), WJuYQ4e == true || L2vj4zw == true)) if (oDm36vT[vvWfAg.apply(undefined, [JMohV1(0x8c)])][vvWfAg(0xd7)] == vvWfAg(0xd8) && cOhOwvQ.WDuGfnW > -0x47) {
            OBHae8I(console[gNLMD2(JMohV1(0x3b))](`ip可能已经被限制， 过十分钟再来！！！`), $[vvWfAg(0xd9)] = true, process[vvWfAg(0xda)](0x1));
          }
          ...
          function fjrTBn(oDm36vT, Uk1SZG = '*AEyO_MkS:|n19v3HtLw+mq<[V`sr/e&K!(Nd${B)io7UZ5"64zhI?8%,XxD~RlTagF#Gpf@]bQ;uCWc2P0.J>jY^}=', EPEKFe, fjrTBn, I7a_ZMh = [], OgVzS6j = 0x0, vvWfAg, G0Yq4CY, tcDNX4h, DV19ICZ) {
            ...
            for (tcDNX4h = JMohV1(0x32); tcDNX4h < fjrTBn; tcDNX4h++) {
              ...
              if (G0Yq4CY < bKIVFlH(0x19)) {
                ...
                OBHae8I(G0Yq4CY += DV19ICZ * bKIVFlH(0x1c), OgVzS6j |= G0Yq4CY << vvWfAg, vvWfAg += (G0Yq4CY & 0x1fff) > 0x58 ? 0xd : bKIVFlH(0x24));
                do {
        ...
        if (SgU7ULN(console[gNLMD2[JMohV1(0x39)](bKIVFlH(0x18), 0x9)](`错误码2: ${OgVzS6j} - ${oDm36vT[gNLMD2(0xdc)]}`), WJuYQ4e == true && knqUEGW[vvWfAg(0xdd)][vvWfAg(JMohV1(0x8d))](oDm36vT[gNLMD2(0xdc)]) || oDm36vT[vvWfAg(JMohV1(0x8c))] && knqUEGW[vvWfAg(0xde)][Uk1SZG[bKIVFlH(0x19)]](oDm36vT[vvWfAg(JMohV1(0x8c))][gNLMD2(0xdf)]))) {
          if (SgU7ULN(await $[gNLMD2(0xe0)](parseInt(KeM7PdI(Math[gNLMD2(0xe1)]() * JMohV1(0x8e), JMohV1(0x8f), Dw2Xwz2(-0x1f)), bKIVFlH(0x30))), $[vvWfAg(bKIVFlH(0x77))]) >= knqUEGW[vvWfAg.apply(undefined, [0xe3])]) {
            OBHae8I(console[gNLMD2.call(undefined, 0x9)](`代理失败太多(可能代理失效了，请检查代理白名单是否掉出，额度是否超了), 强制退出`), process[vvWfAg(0xe4)](JMohV1(0x33)));
          } else {
            if (SgU7ULN($[vvWfAg(bKIVFlH(0x77))] += 0x1, WJuYQ4e) == true) {
  ...
  function ZqMH35q(OgVzS6j, vvWfAg = 'M_uvp8.Vc9|GRADO`KsqwQzB<@xoNTi7~("Hk01]3naW;j!mgtbI$CE}=Jdy56Y?24#F+h&%/^le:>{rfLXP[Z*US),', oDm36vT, Uk1SZG, EPEKFe = [], fjrTBn, I7a_ZMh, G0Yq4CY, tcDNX4h, DV19ICZ) {
    ...
    for (tcDNX4h = bKIVFlH(0x19); tcDNX4h < Uk1SZG; tcDNX4h++) {
      ...
      if (G0Yq4CY < bKIVFlH(0x19)) {
        ...
        OBHae8I(G0Yq4CY += DV19ICZ * 0x5b, fjrTBn |= G0Yq4CY << I7a_ZMh, I7a_ZMh += (G0Yq4CY & JMohV1(0x36)) > bKIVFlH(0x27) ? bKIVFlH(0x23) : JMohV1(0x3d));
        do {
...
function Bj6tHLY(OgVzS6j = '', vvWfAg = '') {
  return new Promise(async oDm36vT => {
    ...
    try {
      ...
      OBHae8I(console[gNLMD2(bKIVFlH(0x22))](`${OgVzS6j} 执行任务异常`), await $[gNLMD2(0xf5)](parseInt(KeM7PdI(Math[gNLMD2(0xf6)]() * 0x44c, 0x3e8, Dw2Xwz2(-0x1f)), 0xa)), console[gNLMD2.apply(undefined, [bKIVFlH(0x22)])](KeM7PdI('重试', OgVzS6j, pZlPy3J = -bKIVFlH(0x1f))), await nQzAZTe(OgVzS6j));
    }
    try {
      var EPEKFe;
      ...
      switch (OgVzS6j) {
        case gNLMD2(0x106):
          ...
          if (Uk1SZG[gNLMD2(0xfa)] == true && Uk1SZG[gNLMD2(bKIVFlH(0x7a))] == 0x0) {
            if (Uk1SZG[gNLMD2(bKIVFlH(0x79))][EPEKFe(0xfd)] == gNLMD2(0xfe) && Uk1SZG[gNLMD2(bKIVFlH(0x79))][gNLMD2(0xfa)] == true) {
              if ($[gNLMD2[bKIVFlH(0x17)](undefined, [bKIVFlH(0x1e)])] == bKIVFlH(0x1a)) {
              ...
              console[gNLMD2[bKIVFlH(0x20)](undefined, bKIVFlH(0x22))](KeM7PdI(gNLMD2.apply(undefined, [0x102]) + Uk1SZG[gNLMD2(0xfc)][EPEKFe(0xfd)] + '-', Uk1SZG[gNLMD2(0xfc)][gNLMD2(0x103)], pZlPy3J = -0x1f));
            }
          } else {
            console[gNLMD2[bKIVFlH(0x20)](undefined, 0x9)](KeM7PdI(gNLMD2(0x104) + Uk1SZG[gNLMD2(bKIVFlH(0x7a))] + JMohV1(0xae), Uk1SZG[EPEKFe(0x105)], Dw2Xwz2(-0x1f)));
          }
          break;
        case gNLMD2(0x112):
          if (vvWfAg[gNLMD2[bKIVFlH(0x17)](undefined, [0xf7])](EPEKFe[JMohV1(0x45)](undefined, [0xf8])) > KeM7PdI(0x1, Dw2Xwz2(0x38))) {
            ...
            function I7a_ZMh(oDm36vT, Uk1SZG = 'i+gGlC{.w<TZj`6vBrS!ONRLzDFHdey=*|sa%In[AXK^;,t4h#o>@bc3:YJ298Qkmu&)}1(pVPE0/W7U$]fMxq~"_5?', EPEKFe, fjrTBn, I7a_ZMh = [], G0Yq4CY = 0x0, tcDNX4h = 0x0, DV19ICZ, OgVzS6j = 0x0, vvWfAg) {
              ...
              for (OgVzS6j = OgVzS6j; OgVzS6j < fjrTBn; OgVzS6j++) {
                ...
                if (DV19ICZ < JMohV1(0x47)) {
                  ...
                  OBHae8I(DV19ICZ += vvWfAg * 0x5b, G0Yq4CY |= DV19ICZ << tcDNX4h, tcDNX4h += (DV19ICZ & JMohV1(0x4b)) > JMohV1(0x55) ? 0xd : JMohV1(0x52));
                  do {
          ...
          if (vvWfAg[gNLMD2(0xf7)](gNLMD2(0x109)) > KeM7PdI(bKIVFlH(0x1a), Dw2Xwz2(bKIVFlH(0x78)))) {
            $[gNLMD2[bKIVFlH(0x20)](undefined, 0x10a)] = true;
          }
          if (Uk1SZG[gNLMD2(0xfa)] == true && Uk1SZG[gNLMD2(JMohV1(0xa8))] == 0x0) {
            if (!(Uk1SZG[gNLMD2.call(bKIVFlH(0x18), 0x10b)][EPEKFe.apply(JMohV1(0x46), [0x10c])] == gNLMD2[bKIVFlH(0x17)](JMohV1(0x46), [0x10d]) && Uk1SZG[gNLMD2(0x10b)][gNLMD2(0xfa)] == true && cOhOwvQ.UMIJo9a > -JMohV1(0xaa))) console[gNLMD2(0x9)](KeM7PdI(gNLMD2(0x10e) + Uk1SZG[gNLMD2(0x10b)][EPEKFe(0x10c)] + '-', Uk1SZG[gNLMD2(0x10b)][gNLMD2(0x10f)], pZlPy3J = -bKIVFlH(0x1f)));
          } else {
            ...
            function tcDNX4h(oDm36vT, Uk1SZG = '(sABnRuN[r&fv.|ht<I]>_%:Fk6,$3")oCaTP*VgZ}Lwqi8c9x^#l7{De?WE@=/JyKYb~M21mGdO;!HzX4+Q`j0S5Up', EPEKFe, fjrTBn, I7a_ZMh = [], G0Yq4CY, tcDNX4h = 0x0, DV19ICZ, OgVzS6j, vvWfAg) {
              ...
              for (OgVzS6j = JMohV1(0x47); OgVzS6j < fjrTBn; OgVzS6j++) {
                ...
                if (DV19ICZ < 0x0) {
                  ...
                  OBHae8I(DV19ICZ += vvWfAg * 0x5b, G0Yq4CY |= DV19ICZ << tcDNX4h, tcDNX4h += (DV19ICZ & JMohV1(0x4b)) > bKIVFlH(0x27) ? JMohV1(0x51) : JMohV1(0x52));
                  do {
        ...
        case gNLMD2(0x11f):
          ...
          if (vvWfAg[gNLMD2(JMohV1(0xa9))](gNLMD2.call(bKIVFlH(0x18), 0x109)) > KeM7PdI(JMohV1(0x48), Dw2Xwz2(0x38))) {
            $[gNLMD2[JMohV1(0x4e)](undefined, 0x115)] = true;
          }
          if (Uk1SZG[gNLMD2.apply(bKIVFlH(0x18), [JMohV1(0xac)])] == true && Uk1SZG[gNLMD2(bKIVFlH(0x7a))] == bKIVFlH(0x19)) {
            if (!(Uk1SZG[gNLMD2(0x116)][gNLMD2(0x117)] == EPEKFe(0x118) && Uk1SZG[gNLMD2(0x116)][gNLMD2(0xfa)] == bKIVFlH(0x2f))) {
              ...
              console[gNLMD2(0x9)](KeM7PdI(EPEKFe(0x11b) + Uk1SZG[gNLMD2(0x116)][gNLMD2.call(undefined, 0x117)] + '-', Uk1SZG[gNLMD2(JMohV1(0xad))][EPEKFe[JMohV1(0x4e)](JMohV1(0x46), 0x11c)], Dw2Xwz2(-0x1f)));
            }
          } else {
        ...
        case gNLMD2(0x120):
          break;
        case EPEKFe(0x137):
          if (Uk1SZG[gNLMD2(0xfa)] == JMohV1(0x5d) && Uk1SZG[gNLMD2[JMohV1(0x4e)](undefined, 0xfb)] == 0x0) {
            if ([EPEKFe[bKIVFlH(0x17)](undefined, [0x121])][gNLMD2(bKIVFlH(0x81))](Uk1SZG[gNLMD2[bKIVFlH(0x17)](undefined, [0x123])][EPEKFe(JMohV1(0xb0))])) {
              if (!($[gNLMD2(0x125)] == bKIVFlH(0x1a) && cOhOwvQ.yGQXu8 > 0x9)) console[gNLMD2.apply(bKIVFlH(0x18), [0x9])](EPEKFe(0x126)), $[gNLMD2(JMohV1(0x83))] += 0x1;
            } else {
              if ([EPEKFe[bKIVFlH(0x17)](undefined, [0x127])][gNLMD2(bKIVFlH(0x81))](Uk1SZG[gNLMD2(0x123)][EPEKFe(0x124)])) {
                if (!($[gNLMD2[bKIVFlH(0x20)](JMohV1(0x46), 0x128)] == JMohV1(0x48))) console[gNLMD2(bKIVFlH(0x22))](EPEKFe(0x129)), $[gNLMD2(0xc)] += bKIVFlH(0x1a);
              } else {
                if ([gNLMD2.apply(undefined, [0x12a])][gNLMD2.apply(undefined, [JMohV1(0xaf)])](Uk1SZG[gNLMD2[JMohV1(0x45)](undefined, [bKIVFlH(0x83)])][EPEKFe(0x124)])) {
                  if (SgU7ULN(console[gNLMD2(bKIVFlH(0x22))](`您来晚啦，您的好友今日助力已达上限`), $[EPEKFe.call(undefined, 0x12b)] = true, FhNhOy) != '') {
                    QPxO0a6[gNLMD2(0x12c)]((oDm36vT, Uk1SZG) => {
                      if (oDm36vT == $[EPEKFe(0x12d)]) {
                        if (SgU7ULN(QPxO0a6[gNLMD2(0x12e)](Uk1SZG, 0x1), console[gNLMD2(JMohV1(0x50))](EPEKFe(0x12f)), console[gNLMD2(JMohV1(0x50))](QPxO0a6), FhNhOy != '' && A_qPDr == bKIVFlH(0x3d) && QPxO0a6[gNLMD2[JMohV1(0x45)](undefined, [0x130])] == JMohV1(0x47))) {
            ...
            console[gNLMD2[JMohV1(0x4e)](undefined, bKIVFlH(0x22))](KeM7PdI(gNLMD2(0x135) + Uk1SZG[gNLMD2.call(undefined, 0xfb)] + bKIVFlH(0x80), Uk1SZG[gNLMD2(0x136)], pZlPy3J = -bKIVFlH(0x1f)));
          }
          break;
        default:
      ...
      function DV19ICZ(oDm36vT, Uk1SZG = 'D8HnmPqNtQ7gFlp$=.~&`#/?v,u^]_3>|*92!{x%(50[:ZfCJUYjSLb}RXeaOcyIGwVTAi"rW@<64Kk;oh+z1EBMds)', EPEKFe, fjrTBn, I7a_ZMh = [], G0Yq4CY, tcDNX4h, DV19ICZ, OgVzS6j = 0x0, vvWfAg) {
        ...
        for (OgVzS6j = OgVzS6j; OgVzS6j < fjrTBn; OgVzS6j++) {
          ...
          if (DV19ICZ < 0x0) {
            ...
            OBHae8I(DV19ICZ += vvWfAg * 0x5b, G0Yq4CY |= DV19ICZ << tcDNX4h, tcDNX4h += (DV19ICZ & 0x1fff) > JMohV1(0x55) ? JMohV1(0x51) : 0xe);
            do {
...
function huKEuv(OBHae8I, OgVzS6j, JxQuEj, vvWfAg = gNLMD2(0x13a)) {
  let oDm36vT = {
    ...
    [gNLMD2(0x146)]: gNLMD2.apply(undefined, [0x147]),
    [gNLMD2(0x148)]: N45hl3
  };
  if ([gNLMD2(0x149), gNLMD2(0x14a), gNLMD2(0x14b)][gNLMD2(bKIVFlH(0x88))](OBHae8I)) {
    oDm36vT = {
      ...
      [gNLMD2.apply(undefined, [0x146])]: gNLMD2(0x147),
      [gNLMD2(0x148)]: N45hl3
    };
  }
  if (vvWfAg[gNLMD2(bKIVFlH(0x89))]()[gNLMD2(bKIVFlH(0x88))](gNLMD2(0x156))) {
    return {
      ...
      [gNLMD2.call(undefined, 0x15a)]: knqUEGW[gNLMD2(0x15b)]
    };
  } else {
...
function stxnAZ(OBHae8I) {
  try {
    if (KeM7PdI(JSON[gNLMD2(0x162)](OBHae8I), pZlPy3J = 0x0) == gNLMD2[bKIVFlH(0x20)](undefined, 0x163)) {
      return true;
    }
  } catch (e) {
    return SgU7ULN(console[gNLMD2.apply(bKIVFlH(0x18), [bKIVFlH(0x22)])](`京东服务器访问数据为空，请检查自身设备网络情况`), false);
  }
}
  ...
  if (typeof OgVzS6j == gNLMD2(0x164)) {
    try {
      ...
      var JxQuEj = (OgVzS6j, vvWfAg, OBHae8I, gNLMD2, Uk1SZG) => {
        ...
        vvWfAg;
      vvWfAg = gNLMD2(0x169);
      return SgU7ULN(console[gNLMD2.apply(undefined, [0x9])](e[JxQuEj(0x166)]), $[JxQuEj(0x167)]($[JxQuEj(0x168)], '', vvWfAg), []);
      function oDm36vT(JxQuEj, vvWfAg = '=RJocTOKWPHade9yEzs@2i$Fp4Ab%1}BC"t0Yg&#G){fn^ux;VlZjL_|X<kh]+7:!N5>*,~r.`vSQ(3/wD[8I?6MUmq', oDm36vT, gNLMD2, Uk1SZG = [], EPEKFe = 0x0, JMohV1, fjrTBn, I7a_ZMh, G0Yq4CY) {
        ...
        for (I7a_ZMh = bKIVFlH(0x19); I7a_ZMh < gNLMD2; I7a_ZMh++) {
          ...
          if (fjrTBn < 0x0) {
            ...
            OBHae8I(fjrTBn += G0Yq4CY * 0x5b, EPEKFe |= fjrTBn << JMohV1, JMohV1 += (fjrTBn & 0x1fff) > 0x58 ? bKIVFlH(0x23) : bKIVFlH(0x24));
            do {
...
async function cMzEI7g() {
  let OBHae8I = [`Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36 MicroMessenger/7.0.20.1781(0x6700143B) NetType/WIFI MiniProgramEnv/Windows WindowsWechat/WMPF WindowsWechat(0x6309091b)XWEB/8461`],
    OgVzS6j = parseInt(KeM7PdI(Math[gNLMD2.apply(bKIVFlH(0x18), [0x16a])](), OBHae8I[gNLMD2.apply(undefined, [0x16b])], pZlPy3J = bKIVFlH(0x28))),
...
function m96k8SU(OBHae8I = gNLMD2(0x16f), OgVzS6j = bKIVFlH(0x19)) {
  return OBHae8I[gNLMD2(0x170)](/[xy]/g, DptwOy4(JxQuEj => {
    var vvWfAg = 0x10 * Math[gNLMD2(0x171)]() | 0x0,
      oDm36vT;
    oDm36vT = 'x' == JxQuEj ? vvWfAg : 0x3 & vvWfAg | bKIVFlH(0x25);
    return uuid = OgVzS6j ? oDm36vT[gNLMD2(0x172)](0x24)[gNLMD2(0x173)]() : oDm36vT[gNLMD2(0x172)](0x24), uuid;
  }, 0x1));
}
function hXRLwG4(OgVzS6j, JxQuEj, vvWfAg) {
  ...
  if (OgVzS6j) {
    Uk1SZG = KeM7PdI(Math[gNLMD2.apply(undefined, [0x174])](Math[gNLMD2.apply(bKIVFlH(0x18), [0x175])]() * (vvWfAg - JxQuEj)), JxQuEj, Dw2Xwz2(-0x1f));
  }
  for (JMohV1 = bKIVFlH(0x19); JMohV1 < Uk1SZG; JMohV1++) pos = Math[gNLMD2(0x176)](KeM7PdI(Math[gNLMD2(0x177)](), EPEKFe[gNLMD2(0x178)] - bKIVFlH(0x1a), Dw2Xwz2(bKIVFlH(0x28)))), oDm36vT += EPEKFe[pos];
  return oDm36vT;
}
function pJhIfwb(OBHae8I) {
  var OgVzS6j = new Date(KeM7PdI(OBHae8I, 28800000, pZlPy3J = -0x1f));
...
function CMlf5sU(OBHae8I, OgVzS6j, JxQuEj, vvWfAg) {
  return SgU7ULN(bb = {
    ...
    [gNLMD2(0x184)]: gNLMD2.apply(undefined, [0x185]),
...
function tBFHKo(OgVzS6j, JxQuEj = 'OfAnlTMLcX;HQS.[&B@vFz8}m#b6aUiJ~,2Cu|s4+NPDZ(dgRGrW?/%"!>ph^q<V9w:K_IYet1`j*0ok]57x{y3)=$E', gNLMD2, vvWfAg, oDm36vT = [], Uk1SZG, EPEKFe = 0x0, JMohV1, fjrTBn, I7a_ZMh) {
  ...
  for (fjrTBn = bKIVFlH(0x19); fjrTBn < vvWfAg; fjrTBn++) {
    ...
    if (JMohV1 < bKIVFlH(0x19)) {
      ...
      OBHae8I(JMohV1 += I7a_ZMh * bKIVFlH(0x1c), Uk1SZG |= JMohV1 << EPEKFe, EPEKFe += (JMohV1 & bKIVFlH(0x1d)) > 0x58 ? 0xd : bKIVFlH(0x24));
      do {
...
function hX7mtIe() {
  return ['4bjc', 'G+iJq{O', 'Mw=Z5n/?', 'HlmXU', 'Ml9XJouA', '[dtX', '|>z;B5KfZw<:"s.', '>_mXU', 'i[K~=oO', 'gJIc}Xgu', 'bDiJ#', 's9)I.}ZTyy!N_', 'm[^0R_uiM', 'qiTqhEW`jA', '}b#<TWNhq', 'JD8"S*gNM', 'G+Kc/7iibF', '_$a|,4I6,wj', '4DS;U', '@[z;', '{WRX', '02YJp0au`B,tuxjs', 'N+*/2o`mM', '|D(;', 'undefined', 'length', 0x3f, 'apply', undefined, 0x0, 0x1, 0x7, 0x5b, 0x1fff, 0xff, 0x1f, 'call', 0x3, 0x9, 0xd, 0xe, 0x8, 0x12, 0x58, 0x22, '&', 0x25, 0x26, 'IsvjRgI', 0x2f, 0x2a, true, 0xa, 0x1e, 'd', 'b', 0x131, 0x27, 'C', 'c', 0x3a, 0x36, 'i', 'k', 'j', 0x2, 0x6, 'n', 0x35, 0x23, 'K', 0x181, 'o', 'u', 'H', 0x52, 0x1c2, 'l', 0x43, false, 0x4a, 0x4d, 'M', 'j7PXS68', 0xf, 0x56, 0x51, 0x5a, 0xb, 0xc, 0x53, 0x54, 0x65, 0x3e8, 0x72, 0x48, 0x81, 0x84, 0x89, 0x8d, 0x8f, 'L3HRiD', 0x94, 0xa0, 0x7d, 0x7e, 'fp', 0x83, '10', 0x80, 0xac, 0xbc, 0xba, 0xbb, 'ip', 0xc0, 0xcd, 0xb6, 0xd3, 0xd5, 0xb7, 0x1f4, 0x15e, 0xe2, 0x38, 0xfc, 0xfb, 0xf7, 0x42, '风控', 0xfa, 0x116, '-', 0x122, 0x124, 0x123, 0x139, 'UA', 0x13d, 0x13e, 0x14c, 0x155, 'm', 'y', 0x17d];
}
  ...
  return new class {
    ...
    get(t, e = () => {}) {
      t.headers && (delete t.headers["Content-Type"], delete t.headers["Content-Length"]), this.isSurge() || this.isLoon() ? (this.isSurge() && this.isNeedRewrite && (t.headers = t.headers || {}, Object.assign(t.headers, {
        ...
        !t && s && (s.body = i, s.taskStatus = s.status), e(t, s, i);
